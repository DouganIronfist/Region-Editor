 ...
 *   Filename    : Regions.cs
 *   
 *   Description : Static utility class that manages the regions.xml file
 *
...
namespace Region_Editor
{
    ...
    {
        #region Variables
        internal static Facet[] Facets;
        #endregion

        #region InitializeFacets
        ...
        protected static Region LoadRegion(XmlElement xml)
        {
            ...
            if (region.Type != "" && region.Type != null && !Parameters.RegionTypes.Contains(region.Type))
                Parameters.RegionTypes.Add(region.Type);
        ...
        #region ReadString
        internal static string ReadString(XmlElement xml, string attribute)
        {
        ...
        #region ReadInt32
        internal static int ReadInt32(XmlElement xml, string attribute)
        {
        ...
        #region ReadBoolean
        internal static bool ReadBoolean(XmlElement xml, string attribute, bool defaultValue)
        {
            string s = GetAttribute(xml, attribute);
        ...
        #region ReadTimeSpan
        internal static TimeSpan ReadTimeSpan(XmlElement xml, string attribute)
        {
            string s = GetAttribute(xml, attribute);
        ...
        internal static Rectangle ReadRectangle(XmlElement xml)
        {
            ...
            else if (xml.HasAttribute("x1"))
            {
                int x1 = ReadInt32(xml, "x1");
                int y1 = ReadInt32(xml, "y1");
                int x2 = ReadInt32(xml, "x2");
                int y2 = ReadInt32(xml, "y2");
        ...
        #region SaveRegions
        internal static void SaveRegions()
        {
            try
            {
                if (System.IO.File.Exists(Parameters.RegionsFile))
